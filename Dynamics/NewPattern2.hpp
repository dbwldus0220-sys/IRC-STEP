...
public:
	...
	int Return_Sim_n();
	double Get_Del_T() const;
	VectorXd Get_xCP();
	VectorXd Get_yCP();
	RowVectorXd Get_xZMP();
	RowVectorXd Get_yZMP();
	const Eigen::MatrixXd& Get_Ref_RL_X() const;
	const Eigen::MatrixXd& Get_Ref_RL_Y() const;
	const Eigen::MatrixXd& Get_Ref_RL_Z() const;
	const Eigen::MatrixXd& Get_Ref_LL_X() const;
	const Eigen::MatrixXd& Get_Ref_LL_Y() const;
	const Eigen::MatrixXd& Get_Ref_LL_Z() const;
